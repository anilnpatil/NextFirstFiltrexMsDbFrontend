...
//     const shiftParam = this.shift === 'ALL' ? null : Number(this.shift);

//     this.loading = true;
//     this.errorMessage = null;
//     this.updateFilterButtons();

//     this.service.fetch(this.from, this.to, this.sku, shiftParam)
...
//           this.loading = false;
//           this.errorMessage = error?.message ?? 'Failed to load production report. Please try again.';
//           this.updateFilterButtons();
//           this.cdr.markForCheck();
//         }
//       });
...
//       if (!map.has(gk)) {
//         map.set(gk, { key, sku: r.sku, shift: r.shift, totalCount: 0, okCount: 0, notOkCount: 0 });
//       }
